...
<body class="easyui-layout">
    <div data-options="region:'north',split:true, collapsible:false" style="height: 5%; color:blue;"></div>
    ...
    <div data-options="region:'west',title:'菜单',split:true" style="width: 25%; height: 81%;">
        <div id="myAccordion" class="easyui-accordion" style="width: 100%; height: 100%;">
            <div title="成绩查询" data-options="iconCls:'icon-user'" style="overflow: auto; padding: 10px;">
                <ul id="myTree"></ul>  
            </div>
            <div title="编辑自身信息" data-options="iconCls:'icon-information',selected:true" style="padding: 10px;">
               <ul id="myTree1"></ul>  
            </div>
...
<script src="Scripts/STree.js"></script>
